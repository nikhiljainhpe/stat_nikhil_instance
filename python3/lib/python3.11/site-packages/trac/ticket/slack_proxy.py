...
SLACK_WEBHOOK_URL = os.environ.get(
    'SLACK_WEBHOOK_URL',
    'https://hooks.slack.com/triggers/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'
)
ACTIVE_TICKETS_WEBHOOK_URL = os.environ.get(
    'ACTIVE_TICKETS_WEBHOOK_URL',
    'https://hooks.slack.com/triggers/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'
)
...
def set_interval():
    ...
    msg = f"✅ Polling interval set to {new_interval} minutes."
    logger.info(msg)
