  ...
  <body>
    ...
    <div id="content" class="ticket">
      ...
      function addToSlack() {
        ...
        // var text2 = [];
        // if (window.location.href) text2.push(window.location.href)

        // var ticket_url = text2.join("")

        var parts = [];
        //if (ticket_url) parts.push(ticket_url)
        ...
        // var ticket_url = window.location.origin + "/ticket/" + ticket_id;
        // parts.push("Link: " + ticket_url);
        // # endif

        var text = parts.join(" | ");
        console.log("ticket_url being sent:", ticket_url);
